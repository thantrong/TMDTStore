...
namespace TMDTStore.Migrations
{
    ...
    [Migration("20260702041845_AddProductVariantDetailFields")]
    partial class AddProductVariantDetailFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TMDTStore.Models.Brand", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
            ...
            modelBuilder.Entity("TMDTStore.Models.ProductVariant", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                    ...
                    b.HasIndex(new[] { "Sku" }, "ix_product_variants_sku")
                        .IsUnique();
            ...
            modelBuilder.Entity("TMDTStore.Models.Product", b =>
                {
                    b.HasOne("TMDTStore.Models.Brand", "Brand")
                        .WithMany("Products")
